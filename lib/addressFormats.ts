...
const EG: AddressFieldSpec[] = [
  { key: 'line1', labelKey: 'address', fallback: 'Street address', required: true, autoComplete: 'address-line1', className: 'sm:col-span-2' },
...
const GB: AddressFieldSpec[] = [
  { key: 'line1', labelKey: 'address', fallback: 'Address line 1', required: true, autoComplete: 'address-line1', className: 'sm:col-span-2' },
...
const DEFAULT: AddressFieldSpec[] = [
  { key: 'line1', labelKey: 'address', fallback: 'Address', required: true, autoComplete: 'address-line1', className: 'sm:col-span-2' },
  { key: 'city', labelKey: 'city', fallback: 'City', required: true, autoComplete: 'address-level2' },

...
const Login: React.FC<LoginProps> = ({ t }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[var(--color-background)] p-4 md:p-6 relative overflow-hidden">
      ...
      <div className="bg-white/5 backdrop-blur-2xl ring-1 ring-white/10 px-6 md:px-10 py-6 md:py-12 rounded-3xl shadow-2xl max-w-md w-full text-center relative z-10">
        <button 
          onClick={() => navigate(-1)}
        ...
        <div className="relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4 mb-4 md:mb-6">
            <div className="relative">
              ...
              <input
                ...
                className="w-full ps-10 pe-4 py-2.5 md:py-3 bg-white/5 backdrop-blur-sm rounded-xl focus:bg-white/10 focus:ring-2 focus:ring-[hsla(var(--color-primary-hsl-values),0.45)] outline-none text-[var(--color-text-primary)] transition-all"
          ...
          <button
            ...
            type="button"
            className="w-full py-2.5 md:py-3 px-4 bg-white/5 backdrop-blur-sm rounded-xl text-[var(--color-text-primary)] font-medium hover:bg-white/10 transition-colors flex items-center justify-center gap-3 mb-4 md:mb-6"
          >

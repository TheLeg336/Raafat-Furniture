...
const FALLBACKS: Record<number, { q: string; a: string }> = {
  ...
  5: { q: 'How do custom orders work?', a: 'Choose “Custom order” at checkout or contact us with your specification. We confirm the design, dimensions, materials and price, take a deposit, and start production. Custom pieces are non-returnable.' },

...
const Hero: React.FC<HeroProps> = ({ t }) => {
  ...
  const bgImage = settings.heroImageUrl || 'https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?auto=format&fit=crop&w=1920&q=80';
  ...
  return (
    <div ref={heroRef} className="relative grain text-white h-[88vh] md:h-[100dvh] min-h-[560px] overflow-hidden">
      ...
      {/* Soft gold aurora behind the headline */}
      {!reduce && <div className="aurora z-[1] opacity-50" aria-hidden="true" />}

      {/* Pre-render twin to warm the glass styles (prevents first-click jank) */}

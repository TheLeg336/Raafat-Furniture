...
const VisitUsSection: React.FC<{ t: TFunction }> = ({ t }) => (
  <section id="visit-us" className="bg-[var(--color-background)] py-16 md:py-24 lg:py-28 transition-colors duration-500" style={{ overflowAnchor: 'none', scrollSnapAlign: 'none' }} aria-labelledby="visit-us-heading">
